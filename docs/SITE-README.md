...
The page has seven sections: hero, problem framing, loop diagram, shipped capabilities, quickstart, case study (Scrawl), and the book. The shipped-capabilities section now includes the URL-to-app reverse-engineering flow alongside planner, model-client, and fidelity checker. Aesthetic matches the book cover and Scrawl's product palette: warm cream paper `#f6efe1`, ink-black type `#1f1a17`, teal accent `#2f6b72`, hand-drawn irregular corner radii on panels and buttons.
